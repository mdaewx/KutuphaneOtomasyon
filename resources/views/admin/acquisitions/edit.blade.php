...
@section('title', 'Edinme Kaynağı Düzenle')

@section('content')
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Edinme Kaynağı Düzenle</h1>
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form action="{{ route('admin.acquisitions.update', $acquisition->id) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('source_name') is-invalid @enderror" 
                           id="source_name" name="source_name" value="{{ old('source_name', $acquisition->source_name) }}" required>
                    @error('source_name')
