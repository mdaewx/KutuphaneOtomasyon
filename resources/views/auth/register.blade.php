                        ...
                        <form action="{{ route('register') }}" method="POST">
                            ...
                            <div class="mb-3">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="name" class="form-control" placeholder="Ad Soyad" required value="{{ old('name') }}">
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                <div class="input-group">
                                    ...
                                    <input type="email" name="email" class="form-control" placeholder="E-posta Adresi" required value="{{ old('email') }}">
                                </div>
                            </div>
